...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordHasherInterface $userPasswordHasher, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $passwordHased = $userPasswordHasher->hashPassword($user,$form->get('password')->getData());
            ...
            $this->emailVerifier->sendEmailConfirmation('visitor.verification.email', $user,
                (new TemplatedEmail())
                    ->from(new Address('electrotech@gmail.com', 'elctroTech Bot'))
                    ->to($user->getEmail())
    ...
    #[Route('/verify/email', name: 'visitor.verification.email')]
